...
applicants_data = [
    # ─────────────────────────────────────────────────────────
    # UI/UX DESIGNER (Jobdesk Target: UI UX Designer)
    # ─────────────────────────────────────────────────────────
    {
    ...
    # ─────────────────────────────────────────────────────────
    # FRONTEND DEVELOPER (Jobdesk Target: Frontend Developer)
    # ─────────────────────────────────────────────────────────
    {
    ...
    # ─────────────────────────────────────────────────────────
    # BACKEND DEVELOPER (Jobdesk Target: Backend Developer)
    # ─────────────────────────────────────────────────────────
    {
    ...
    # ─────────────────────────────────────────────────────────
    # FULLSTACK DEVELOPER (Jobdesk Target: Fullstack Developer)
    # ─────────────────────────────────────────────────────────
    {
    ...
    },
    {
        ...
        "experience": "Full Stack Programmer di SolusiBisnis (2021 - Sekarang): Membangun sistem ERP internal perusahaan dan modul inventaris gudang berbasis Laravel.",
    ...
    # ─────────────────────────────────────────────────────────
    # NON-IT CONTROL GROUP (Target: Non-IT / Out-of-domain)
    # ─────────────────────────────────────────────────────────
    {
...
def build_pdf_cv(app_info):
    ...
    # Custom colors
    PRIMARY_COLOR = HexColor("#2A4365") # Navy
    SECONDARY_COLOR = HexColor("#4A5568") # Dark Grey
    ...
    story.append(Paragraph(app_info["name"].upper(), title_style))
    story.append(Paragraph(app_info["title"], subtitle_style))
    story.append(Paragraph(f"Email: {app_info['email']} | Lokasi: Jakarta, Indonesia", body_style))
    story.append(Spacer(1, 10))
    
    # 2. Summary
    story.append(Paragraph("RINGKASAN PROFESIONAL", section_heading))
    story.append(Paragraph(app_info["summary"], body_style))
    story.append(Spacer(1, 5))
    
    # 3. Skills
    story.append(Paragraph("KEAHLIAN & TEKNOLOGI", section_heading))
    story.append(Paragraph(app_info["skills"], body_style))
    story.append(Spacer(1, 5))
    
    # 4. Experience
    story.append(Paragraph("PENGALAMAN KERJA", section_heading))
    story.append(Paragraph(app_info["experience"], body_style))
    story.append(Spacer(1, 5))
    
    # 5. Education
    story.append(Paragraph("RIWAYAT PENDIDIKAN", section_heading))
    story.append(Paragraph(app_info["education"], body_style))
...
if __name__ == "__main__":
    print(f"Generating 25 CV PDFs in {UPLOADS_DIR}...")
